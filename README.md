...
<p align="center">
<img src="./assets/method_scheme.png" alt="Figure" height="200" />
</p>
<p align="justify">
...
![<p style="font-size:16px; text-align:justify;">Figure 2: Qualitative comparison between the anomaly maps generated by different methods on PET slices. GT represents the physician’s dense ground truth. Here, we set the noise level <i>D</i> = 400 and <i>w</i> = 3.0.</p>](./assets/plot_comparing_igcondapet_to_other_methods.png)
